...
import baguchan.soul_archeology.block.ModSkullBlock;
import baguchan.soul_archeology.block.ModWallSkullBlock;
...
public class ModBlocks {
    public static final DeferredRegister<Block> BLOCKS = DeferredRegister.create(ForgeRegistries.BLOCKS, SoulArcheology.MODID);

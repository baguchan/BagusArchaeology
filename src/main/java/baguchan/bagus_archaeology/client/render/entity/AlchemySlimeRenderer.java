...
public class AlchemySlimeRenderer<T extends AlchemySlime> extends MobRenderer<T, SlimeModel<T>> {
    private static final ResourceLocation SLIME_LOCATION = new ResourceLocation(RelicsAndAlchemy.MODID, "textures/entity/alchemy_slime.png");

    public AlchemySlimeRenderer(EntityRendererProvider.Context p_174391_) {
    ...
    public ResourceLocation getTextureLocation(T p_115974_) {

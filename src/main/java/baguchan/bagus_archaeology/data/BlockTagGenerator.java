...
public class BlockTagGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        this.tag(BlockTags.MINEABLE_WITH_SHOVEL).add(ModBlocks.SUSPICIOUS_SOUL_SAND.get());
        this.tag(BlockTags.MINEABLE_WITH_SHOVEL).add(ModBlocks.SUSPICIOUS_SOUL_SOIL.get());
    }
}
...
public class AlchemyProjectileItem extends AlchemyItem {
    public AlchemyProjectileItem(Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level p_43142_, Player p_43143_, InteractionHand p_43144_) {
        ...
        if (!p_43142_.isClientSide) {
            AlchemyThrown snowball = new AlchemyThrown(ModEntities.ALCHEMY_THROWN.get(), p_43143_, p_43142_);
